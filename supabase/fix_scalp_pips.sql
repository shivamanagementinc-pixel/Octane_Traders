...
-- scalp rows.
--
-- NOTE: the signals_guard trigger blocks pips_tp updates for non-service_role
-- sessions (including the SQL editor), so we temporarily disable it, repair,
-- then re-enable. Run the WHOLE script once in the Supabase SQL Editor.
-- ============================================================================
